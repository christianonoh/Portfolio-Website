...
seeProjectButton.forEach((p, index) => {
  ...
  <div class="popup-container display-flex-column">
        <div class="close-menu close-pop"><i class="fa fa-times" aria-hidden="true"></i></div>
        ...
        <div class="slider">
          ...
          <div class="popup-btn">
            <button onclick="previous()"><i class="fa fa-chevron-left" aria-hidden="true"></i></button>
            <button onclick="next()"><i class="fa fa-chevron-right" aria-hidden="true"></i></button>
          </div>
        </div>
        <div class="img-icons">
